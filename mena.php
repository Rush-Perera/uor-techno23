...
<head>
    <meta charset="utf-8">
    <title>MENA - FOE-UOR | Techno 2023</title>
    ...
    <div class="cx3hx ctkta c1yb0 cqkfc">
        ...
        <main class="cmm3x">
                        ...
                        <div x-data="{ tab: '1' }">
                            ...
                            <div class="c82l3 cx3hx cbywq c1yb0 cw977 ckwfp cik1e cxp2a c7lcb cj1ja cc6yz crj76">
                                ...
                                <div class="clx9g c810o cls9d" data-aos="fade-down">
                                    ...
                                    <h3 class="cqbmj cyvm0 c1wf5 cj15g ctvzo cnu2b cvbxf c3btc">Department of Marine Engineering and Naval Architecture
                                    </h3>
                                    <p class="c4dav cabeq cwx0r">The Bachelor of Science in Engineering Honors (B.Sc.EngHons) specialization in Marine engineering and Naval Architecture is a newly offered degree programme by the Department of Marine Engineering and Naval Architecture (DMENA).</p>
                ...
                <div class="c82l3 ckx8h cl9xt csj8y">
                    <div class="c9b6d cq2hq">
                        ...
                        <div class="c82l3 cxe5f ch0mu cst88 c6ftu">
                            <h2 class="c7ehl cyvm0 c1wf5 cj15g ctvzo cnu2b ck06v c3btc">Laboratory Facilities</h2>
                            <p class="cabeq cwx0r">In order to develop skills, which are essential in making marine engineering professionals who will be employed in marine industry worldwide. Department of Marine Engineering and Naval Architecture (DMENA) is equipped with the modern laboratory facilities as follows </p>
                            <div style="margin:30px; line-height:2rem;">
                                <li class="list-item" >Naval Architecture Laboratory</li>
                                <li>Marine Dynamics Laboratory</li>
                                ...
                                <li>Engineering Workshop, Engineering Materials Laboratory</li>
                                <li>Fluid Mechanics Laboratory</li>
                                <li>Computer Aided Design Laboratory</li>
                            </div>
                            <p class="cabeq cwx0r">The maritime industry is vast and dynamic, offering a wide range of career opportunities as mentioned above. Your specific career path may depend on your interests, skills, and the specialization within marine engineering and naval architecture that you choose to pursue.</p>
            ...
            <section class="c910c">
                ...
                <!-- Blurred shape -->
                <div class="cd3pv clm9l ck1c9 cto33 cbati c22q0 czhep c5nt0 cf1fs" aria-hidden="true">
                ...
                <div class="c82l3 ckx8h cl9xt csj8y">
                    <div class="cm6b6 cd2en ch0mu c9b6d c6ftu cq2hq">
            
                        <!-- Section header -->
                        <div class="c82l3 cxe5f ch0mu cst88 c6ftu">
                            <h2 class="c7ehl cyvm0 c1wf5 cj15g ctvzo cnu2b ck06v c3btc">Career Oppertunities</h2>
                            <p class="cabeq cwx0r">A degree in Marine Engineering and Naval Architecture can open up various career opportunities in the maritime industry which is challenging, yet highly rewarding. This field combines the principles of engineering and design to create and maintain ships and other waterborne structures. Here are some career options you can pursue with this degree</p>
                            <div style="margin:30px; line-height:2rem;">
                                <li class="list-item" >Marine Engineers</li>
                                <li>Naval Architects</li>
                                <li>Ship and Boat Designers</li>
                                <li>Shipbuilders</li>
                                <li>Marine Surveyors</li>
                                <li>Propulsion Experts</li>
                                <li>Navigation & Guidance System Engineers</li>
                                <li>Hydrodynamic Engineers</li>
                                <li>Port Managers</li>
                                <li>Project Managers</li>
                                <li>Marine Specialists and Consultants</li>
                                <li>Teaching and Academia</li>
                            </div>
                            <p class="cabeq cwx0r">The maritime industry is vast and dynamic, offering a wide range of career opportunities as mentioned above. Your specific career path may depend on your interests The maritime industry is vast and dynamic, offering a wide range of career opportunities as mentioned above. Your specific career path may depend on your interests, skills, and the specialization within marine engineering and naval architecture that you choose to purse
</p>
                            
                        </div>
            
                        <div class="c82l3 cxe5f">
                            <div data-aos="fade-down" class="aos-init aos-animate">
                                <div class="car0u" data-highlighter="">
                                    <div class="c910c cqkfc cvitu cbok3 cxfql cux88 c85im chpt4 cl006 c8bq2 cnnxg cdtjx ciw8g cyaau cr5is c78uy cys3t cq0d5 cdnbd co67a croff cuwru clpi6 c1whm c91wt c4v01 c3zjn cngr8 cbjp0 cdt9a">
                                        <div class="c910c c8yyj c3ztf cqkfc c0a7w cxs0p">
                                            ...
                                            <div class="cd3pv clm9l cj9ju ck1c9 cbati c6prr cp4qc c22q0 cht4j" aria-hidden="true">
                                                <div class="c0ddw clm9l crjl7 c1rz6 cytct cdbh6"></div>
                                            </div>
                                            <img src="./images/home_dept/dmena_feature.png" width="768" height="400" alt="Feature 04">
                                        </div>
                                    </div>
                                </div>
                            </div>
